...
var getRentData = [];
var rentData = [];
var rentBookTimeRagneData = [];

//   const response = await fetch("https://opensheet.elk.sh/1Hmw4yxk5pVyR7CA2XLsw93ozeFrrWVZB7cep_uyDEc4/forFetch");
//   getRentData = await response.json();

//   console.log(getRentData)
...
//     const res = await fetch("https://opensheet.elk.sh/1Hmw4yxk5pVyR7CA2XLsw93ozeFrrWVZB7cep_uyDEc4/forFetch", {
//         method: 'GET',
//         headers: {
...
$(function () {
    ...
    $.ajax({
        type: 'GET',
        url: 'https://opensheet.elk.sh/1Hmw4yxk5pVyR7CA2XLsw93ozeFrrWVZB7cep_uyDEc4/Google表單借閱人紀錄',
        cache: false,
        dataType: 'json',
        success: function (res) {
            ...
            // var rentBooksBackTime = get_rentBooksBackTime(res);
            rentBookTimeRagneData = get_rentBooksTimeRange(res);
        },
    });
    ...
    function get_rentBooksTimeRange(data) {
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            var fromDate = Date.parse(data[i].fromTime)
            var toDate = Date.parse(data[i].toTime)

            var bookIds = data[i].bookIds.split(",");
        ...
        const rentBooks = removeEmptyObjects(arr);
