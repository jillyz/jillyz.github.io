          ...
          <div className="terms-content">
            ...
            <section className="text-highlight">
              ...
              <ul>
                ...
                <li>台中市優先採用面交，亦可郵寄；外縣市一律郵寄。（郵寄需支付運費，視您租借數量而定）（面交地點為：台中市臺灣大道及文心路交界一帶）</li>
              </ul>
            </section>
            <hr/>

            <section className="other-terms">
              <h4 className="other-terms-item">
              【遺失】遺失遊戲本扣除押金 500 元、遺失公車板扣除押金 550 元
              </h4>
              ...
              <h4 className="other-terms-item-content">【破損、污損、折損】按比例賠償</h4>
              <div className="other-terms-item-content">
                <ul>
                  <li>遊戲板子若有破損，若不影響遊戲進行及遊戲安全，則按50%比例賠償；若會影響遊戲進行或影響遊戲安全，則按 100％ 比例賠償。<br/>從押金扣除，若押金不夠扣除，須另補足賠償金額。</li>
            ...
            <section>
              <h4 className="other-terms-item-content">【關於本服務】</h4>
              <div className="other-terms-item-content">
              ...
              <h4 className="other-terms-item-content">【敬請愛惜物品】</h4>
              <div className="other-terms-item-content">
